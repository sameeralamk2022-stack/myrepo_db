      ...
      <div className="relative z-10 w-full max-w-[340px] mx-auto my-auto">
        ...
        >
          <div className="flex flex-col items-center mb-5 text-center">
            ...
            <div className="my-2 w-full bg-white text-[#005f60] py-2 px-3 rounded-lg font-black tracking-widest text-sm uppercase shadow-md flex items-center justify-center">
              <span>ORDERS</span>
            </div>
