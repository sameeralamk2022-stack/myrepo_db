...
export function HomePage({ setCurrentPage }: HomePageProps): JSX.Element {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 pb-24 page-transition relative overflow-hidden">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute top-[-5%] left-[-5%] w-72 h-72 rounded-full bg-gradient-to-tr from-amber-500/15 to-orange-500/5 blur-3xl"
        />
        <motion.div
          animate={{ y: [0, 50, 0], x: [0, -35, 0], scale: [1, 1.15, 1] }}
          transition={{ repeat: Infinity, duration: 22, ease: 'easeInOut', delay: 2 }}
          className="absolute top-[20%] right-[-8%] w-80 h-80 rounded-full bg-gradient-to-tr from-teal-500/12 to-emerald-500/5 blur-3xl"
        />
        <motion.div
          animate={{ y: [0, -30, 0], scale: [1, 1.08, 1] }}
          transition={{ repeat: Infinity, duration: 16, ease: 'easeInOut', delay: 1 }}
          className="absolute bottom-[10%] left-[15%] w-64 h-64 rounded-full bg-gradient-to-tr from-yellow-400/10 to-amber-500/5 blur-3xl"
        />

        {/* 3D perspective grid floor */}
        <div
          className="absolute bottom-0 left-0 right-0 h-[40%] opacity-[0.07]"
          style={{
        ...
        <motion.div
          ...
          className="absolute top-[15%] right-[8%] opacity-[0.08]"
        >
          <Utensils className="w-24 h-24 text-amber-400" />
        </motion.div>
        <motion.div
          animate={{ y: [0, 25, 0], rotate: [0, -15, 0] }}
          transition={{ repeat: Infinity, duration: 9, ease: 'easeInOut', delay: 1 }}
          className="absolute bottom-[25%] right-[12%] opacity-[0.08]"
        >
          <ShoppingBasket className="w-28 h-28 text-amber-400" />
        </motion.div>
        <motion.div
          animate={{ y: [0, -15, 0], rotate: [0, 8, 0] }}
          transition={{ repeat: Infinity, duration: 6, ease: 'easeInOut', delay: 2 }}
          className="absolute top-[40%] left-[5%] opacity-[0.08]"
        >
          <Flame className="w-20 h-20 text-teal-300" />
        </motion.div>
      </div>
      ...
      <div className="relative z-10 overflow-hidden border-b border-slate-800/80 py-10 sm:py-14 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center space-y-4 relative z-10 flex flex-col items-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center space-x-1.5 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-400 text-[10px] sm:text-xs font-black uppercase tracking-wider"
          >
          ...
          <motion.h1
            ...
            className="text-2xl sm:text-5xl font-black tracking-tight text-white"
          >
          ...
          <motion.p
            ...
            className="text-[11px] sm:text-sm font-semibold tracking-wide text-amber-300/90 uppercase"
          >
          ...
          <motion.div
            ...
            className="w-full max-w-lg bg-slate-900/90 border border-amber-500/30 rounded-2xl p-3 sm:p-3.5 space-y-1.5 text-center shadow-xl"
          >
            ...
            <p className="text-[10px] sm:text-[11px] font-bold text-amber-400">
          ...
          <motion.p
            ...
            className="text-[11px] sm:text-sm text-slate-400 max-w-xl mx-auto pt-1"
          >
          ...
          <motion.div
            ...
            className="flex flex-wrap items-center justify-center gap-3 pt-3 sm:pt-4"
          >
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => setCurrentPage('stalls')}
              className="px-5 sm:px-6 py-2.5 sm:py-3 bg-amber-500 hover:bg-amber-400 text-slate-950 rounded-xl font-black text-[11px] sm:text-xs flex items-center space-x-2 shadow-lg shadow-amber-500/20 transition-all cursor-pointer uppercase tracking-wider"
            >
            ...
            <motion.button
              ...
              className="px-5 sm:px-6 py-2.5 sm:py-3 bg-slate-900 hover:bg-slate-800 border border-amber-500/40 text-amber-400 rounded-xl font-black text-[11px] sm:text-xs flex items-center space-x-2 transition-all cursor-pointer uppercase tracking-wider"
            >
      ...
      {/* Food Category Cards */}
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 pt-8 pb-2">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xs sm:text-sm font-black text-amber-400 uppercase tracking-widest flex items-center space-x-2">
            <Flame className="w-4 h-4" />
            <span>What's Craving Today?</span>
          </h2>
          <button
            onClick={() => setCurrentPage('stalls')}
            className="text-[10px] sm:text-[11px] font-bold text-teal-400 hover:text-teal-300 cursor-pointer flex items-center gap-1"
          >
            <span>See All</span>
            ...
            return (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-2.5 sm:p-3 space-y-0.5">
                  <h3 className="text-[11px] sm:text-xs font-black text-white">{cat.name}</h3>
                  <p className="text-[9px] sm:text-[10px] text-slate-300 font-medium truncate">{cat.desc}</p>
                </div>
              </motion.div>
            );
          })}
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-6 space-y-6">
          ...
          {navCards.map((card, idx) => {
            ...
            return (
              <motion.div
                ...
                className="p-4 sm:p-5 rounded-2xl bg-slate-900/90 border border-slate-800 hover:border-amber-500/50 transition-all shadow-xl cursor-pointer group space-y-3 card-glow"
              >
                <div className="flex items-center justify-between">
                  <div className={`p-2.5 sm:p-3 rounded-xl border transition-colors ${accentColors[card.accent]}`}>
                    <Icon className="w-4 h-4 sm:w-5 sm:h-5" />
                  </div>
                  <ArrowRight className="w-4 h-4 text-slate-500 group-hover:text-amber-400 group-hover:translate-x-1 transition-all" />
                </div>
                <div>
                  <h3 className="text-xs sm:text-sm font-black text-white">{card.title}</h3>
                  <p className="text-[10px] sm:text-[11px] text-slate-400 mt-1">{card.desc}</p>
                </div>
              </motion.div>
            );
          })}
        ...
        <div className="p-4 sm:p-5 rounded-2xl bg-gradient-to-r from-amber-500/10 via-slate-900 to-amber-500/10 border border-amber-500/20 grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 text-center">
