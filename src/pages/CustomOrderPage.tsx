        ...
        {success ? (
          ...
          <div className="space-y-6">
                  ...
                  <div key={item.id} className="bg-slate-950 border border-slate-800 rounded-2xl p-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <span className="text-[10px] text-amber-400/80 font-bold uppercase tracking-wider mt-1 inline-block">Price decided by captain</span>
                      </div>
                    </div>
            ...
            <div className="pt-6 border-t border-slate-800 flex items-center justify-between">
              <div>
                <span className="text-xs text-slate-400">Total Items Selected</span>
                <p className="text-xl font-black text-amber-400">{totalItems} item(s)</p>
              </div>
              <button
