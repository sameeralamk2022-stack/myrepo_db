      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-amber-500/10 via-slate-900 to-slate-950 border border-amber-500/20 p-8 sm:p-12">
        ...
        <div className="relative z-10 max-w-2xl space-y-4">
          ...
          <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
            Select any stall below for <span className="text-amber-400 font-bold">Custom Orders</span> (spice levels, portions) or use <span className="text-amber-400 font-bold">Simple Orders</span> for direct quick checkout. Operating strictly between 10:00 AM and 11:30 PM.
          </p>
        </div>
      </div>
